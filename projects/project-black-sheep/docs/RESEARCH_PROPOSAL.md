...
```mermaid
flowchart TD
  L1["1. Real-world interaction and observation"] --> L2["2. Primary narrative or project model"]
  L2 --> L3["3. Embedded narrative derived from an intervention concept"]
  L3 --> L4["4. A system inside the fiction recursively rewrites interactions"]
  L4 --> L5["5. Outputs return as scenes, roles, images, product prototypes or research artifacts"]
  L5 --> L1
```
